...
export default async function ProfilePage() {
  ...
  return (
    <div className="max-w-5xl mx-auto w-full py-8 animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-800 flex justify-between items-center">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-slate-300 font-medium">المتتالية</span>
                </div>
                <div className="font-black text-xl text-white font-mono" dir="ltr">
                  {user.streak}
                </div>
              </div>
            </div>
            ...
            <div className="pt-2">
              <ProgressStrip 
                ...
                label={`هدف الطاقة القادم: ${milestone.next}`}
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="space-y-6">
            <h2 className="text-xl font-black font-display text-white">إنجازاتك</h2>
            <AchievementGrid user={{
              power_level: user.power_level,
              streak: user.streak,
              zenkai_boosts: user.zenkai_boosts
            }} />
          </div>
